import 'package:cashir/features/order_status_tabbars/data/models/address_model.dart';
import 'package:cashir/features/order_status_tabbars/data/models/customer_model.dart';
...
class ItemModel extends Items {
  ...
  factory ItemModel.fromJson(Map<String, dynamic> json) => ItemModel(
    ...
    createdAt: DateTime.parse(json["created_at"]).toString(),
    updatedAt: DateTime.parse(json["updated_at"]).toString(),
    extras: List<ExtraModel>.from(json["extras"].map((x) => ExtraModel.fromJson(x))),
    isHidden: json["is_hidden"],
    doughType: List<DoughTypeModel>.from(json["dough_type"].map((x) => DoughTypeModel.fromJson(x))),
    pivot: PivotModel.fromJson(json["pivot"]),
  );
}

class ExtraModel extends Extras {
  const ExtraModel({required super.id, required super.nameAr, required super.nameEn, required super.descriptionAr, required super.descriptionEn, required super.price, required super.calories, required super.categoryId, required super.deletedAt, required super.createdAt, required super.updatedAt, required super.image});
...
class PivotModel extends Pivot {
  const PivotModel({required super.orderId, required super.itemId, required super.itemExtras, required super.itemWithouts, required super.doughTypeAr, required super.doughTypeEn, required super.price, required super.offerPrice, required super.quantity, required super.offerId});
...
class BranchModel extends Branch {
  const BranchModel({required super.id, required super.nameAr, required super.nameEn, required super.cityId, required super.areaId, required super.addressDescription, required super.addressDescriptionEn, required super.firstPhone, required super.secondPhone, required super.email, required super.deliveryFees, required super.serviceType, required super.createdBy, required super.updatedBy, required super.deletedAt, required super.createdAt, required super.updatedAt});
